...
public class ContrattoTelefonico {
	...
	public void stampaTelefonate() {
		for(int i=0; i<telefonate.size(); i++) {
			System.out.println("telefono: " +telefonate.get(i).getNumeroTelefono() + " " +
								"costoTelefonata: " + telefonate.get(i).getCostoTelefonata() + " " + 
								"durata: " + telefonate.get(i).getDurata());
		}
	}
